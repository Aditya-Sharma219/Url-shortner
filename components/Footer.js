...
const Footer = () => {
  return (
    <footer className="footer">
      <div className="container mx-auto px-5 py-6 flex flex-wrap md:flex-nowrap flex-col sm:flex-row">
        
        <div className="flex flex-wrap md:text-left text-center -mb-10 -mx-4 w-full md:w-1/2">
        ...
        <div className="flex md:flex-nowrap flex-wrap justify-center items-end md:justify-start w-full md:w-1/2">
          <div className="relative sm:w-64 w-full sm:mr-4 mr-2 mb-4 md:mb-0">
      ...
      <div className="bg-gray-100">
        <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
          <p className="text-gray-500 text-sm text-center sm:text-left">© 2025 Your Company —
